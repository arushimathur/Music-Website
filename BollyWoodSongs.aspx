<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BollyWoodSongs.aspx.cs" Inherits="BollyWoodSongs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <div style="padding:10px 10px 10px 10px;">
     <div>
         ...
         <asp:SqlDataSource ID="SqlDataSource1" ConnectionString="<%$ConnectionStrings:oms%>" SelectCommand="select * from movie" runat="server"></asp:SqlDataSource>
     </div>  
   </div>
</asp:Content>
